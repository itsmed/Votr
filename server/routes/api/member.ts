...
router.get('/:bioguideId/agreement', async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error('GET /api/member/:bioguideId/agreement error:', error);
...
router.get('/:bioguideId/shared-votes', async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error('GET /api/member/:bioguideId/shared-votes error:', error);
...
router.get('/:bioguideId', async (req: Request, res: Response) => {
  try {
    ...
    console.error('GET /api/member/:bioguideId error:', error);
